...
import com.io7m.bodyrecomp.core.MaintenanceCalories;
...
public final class MaintenanceCaloriesTest
{
  ...
  public void example()
  {
    ...
    LOG.debug("BMR: {}", bmr);
    for (final var activity : ActivityCoefficient.values()) {
      LOG.debug(
        "Maintenance: {} {}",
        activity,
        MaintenanceCalories.maintenanceEstimate(bmr, activity)
      );
    }
  }
}
